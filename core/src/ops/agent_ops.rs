//! Agent-side writes: full-body `agent_write_note` plus the
//! frontmatter-only helpers (`agent_set_frontmatter`, `agent_apply_tag`,
//! `agent_remove_tag`). Each appends a changelog row authored as
